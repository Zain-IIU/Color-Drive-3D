...
namespace SimpleInputNamespace
{
	public class SteeringWheel : MonoBehaviour, ISimpleInputDraggable
	{
	    ...
	    [SerializeField]private Graphic wheel;
		...
		public float Value { get { return _mValue; } }
		...
		private void OnDisable()
		{
			...
			wheelAngle = wheelPrevAngle = _mValue = 0f;
		...
		private void OnUpdate()
		{
			...
			_mValue = wheelAngle * valueMultiplier / maximumSteeringAngle;
